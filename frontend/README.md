...
│   │   ├── LoginForm.tsx
│   │   ├── Navbar.tsx
│   │   ├── ProgressStateCard.tsx
│   │   ├── ProjectBulletGenerator.tsx
│   │   ├── ResumeCard.tsx
│   │   ├── RoleKeywordAnalysisCard.tsx
│   │   ├── ScoreBadge.tsx
│   │   ├── ScoreCircle.tsx
│   │   ├── ScoreGauge.tsx
│   │   ├── SignupForm.tsx
...
- `QUICK_START.md` - Fast local setup and smoke test flow
- `IMPLEMENTATION_SUMMARY.md` - What is implemented and architecture notes
- `backend/AUTH_GUIDE.md` - Backend auth setup and API flow
